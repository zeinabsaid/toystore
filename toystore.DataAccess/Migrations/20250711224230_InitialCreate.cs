...
namespace toystore.DataAccess.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "/theme_toys/images/item1.jpg", 1 },
                    { 2, "/theme_toys/images/item2.jpg", 2 },
                    { 3, "/theme_toys/images/item3.jpg", 3 },
                    { 4, "/theme_toys/images/item4.jpg", 4 },
                    { 5, "/theme_toys/images/item5.jpg", 5 },
                    { 6, "/theme_toys/images/item6.jpg", 6 },
                    { 7, "/theme_toys/images/item7.jpg", 7 },
                    { 8, "/theme_toys/images/item14.jpg", 8 }
                });
